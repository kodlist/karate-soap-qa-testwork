...
[`first.feature`](src/test/java/demo/tags/first.feature) | Along with [`second.feature`](src/test/java/demo/tags/second.feature) shows how you can use [tags](https://github.com/intuit/karate#cucumber-tags) to selectively run tests or groups of tests from the command-line.
...
#I have cloned this project from intuit/karate and customized as per my needs and trying lot different examples to use it for soap webservices testing in regression phase
#I have cloned this project from intuit/karate and customized as per my needs and trying lot different examples to use it for soap webservices testing in regression phase
